...
export const Logo = ({ size = "lg", onSecretClick, onDoubleClick }: { size?: "sm" | "lg", onSecretClick?: () => void, onDoubleClick?: () => void }) => {
  ...
  return (
    ...
    >
      <Link to="/" className="contents" onClick={(e) => e.preventDefault()}>
